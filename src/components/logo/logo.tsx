...
function Logo({ single = false, sx }: LogoProps) {
  // New logo path
  const logoPath = '/assets/logo/VLA.svg';
  const theme = useTheme();
  const isDarkMode = theme.palette.mode === 'dark';

  const darkModeLogoPath = '/assets/logo/VLA.svg'; // Dark mode logo path
  const lightModeLogoPath = '/assets/logo/VLA-DARK.svg'; // Light mode logo path
